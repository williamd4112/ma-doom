...
def train(config, num_frames, seed, policy, lrschedule, num_cpu, ckpt, nsteps, start_port=8000):
...
def main():
    ...
    while True:
        ...
        policy=args.policy, lrschedule=args.lrschedule, num_cpu=args.ncpu, ckpt=current_ckpt, nsteps=args.nsteps, start_port=args.port)
        time.sleep(3)
